...
namespace Paramdigma.Core.Geometry
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="Box2d" /> class  from 2 points.
        /// </summary>
        /// <param name="bottomLeftCorner">Bottom left corner.</param>
        /// <param name="topRightCorner">Top right corner.</param>
        public Box2d(Point2d bottomLeftCorner, Point2d topRightCorner)
        {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Box2d" /> class from a polyline.
        /// </summary>
        /// <param name="polyline">Polyline.</param>
        public Box2d(Polyline2d polyline)
        {
        ...
        public bool IntersectsBox(Box2d box)
        {
